...
<button onclick="jquery_get()">get请求</button><span id="span0">post请求</span>
<button onclick="jquery_post()">post请求</button><span id="span01">post请求</span>
<button onclick="jquery_ajax()">post请求</button><span id="span02">post请求</span>
